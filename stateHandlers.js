...
var getAudioData = require('./audioAssets');
    ...
    startModeIntentHandlers: Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        */
        'LaunchRequest': function () {
            ...
            var message = 'Welcome to Financial Happiness. You can say, play the audio to begin the Happiness.';
    ...
    playModeIntentHandlers: Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest': function () {
            ...
            if (this.attributes['playbackFinished']) {
                ...
                message = 'You were listening to Tatiana Arias ' + audioData[this.attributes['playOrder'][this.attributes['index']]].title +
